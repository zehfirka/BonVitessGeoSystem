...
public class RetrofitClient {
    private static final String BASE_URL = "https://maps.googleapis.com/"; //тут має бути базове посилання https://maps.googleapis.com/
    private static Retrofit retrofit = null; //https://jsonplaceholder.typicode.com
